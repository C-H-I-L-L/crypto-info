      ...
      <div className='buying-content'>
        ...
        <div className='outline-container'>
          <div className='article-body'>
            ...
            <p>
              Coinbase also has a sister company named <strong>GDAX</strong> -
            ...
            <p>
              ...
              partnered up with Simplex to offer a convenient way to buy
              Bitcoin, Bitcoin Cash, and/or Ethereum. Simplex accepts most
              credit cards (including Visa and Mastercard) and also accepts some
              debit and prepaid cards.
            </p>{' '}
            buy.cointelegraph.com buy.cointelegraph.com Coming Soon:
            Decentralized Exchanges While not very popular yet, mostly because
            the technology is still being worked on, decentralized exchanges
            (DEXs) are set to become more popular in 2018. DEXs use a trustless
            AI system to connect traders online. In a centralized exchange, the
            money goes from the user’s wallet to an escrow, and then to the
            other user in the trade. Funds stored on centralized exchanges are
            stored in wallets owned by the company, making funds more
            susceptible to hacks. In a DEX, user funds are stored in hardware
            wallets on each user’s computer, and value is never lost; when a
            trade commences, and instant swap, i.e., atomic swap, occurs so that
            the money never passes through a middleman. A smart contract is used
            to keep trust between the two users trading the money. Altcoin.io is
            working hard to make the first ever decentralized exchanges for
            traders, by traders. While many DEXs have bulky, complicated
            interfaces; Altcoin.io is working to make both a simple interface to
            quickly exchange crypto, as well as an in-depth, customizable
            exchange. The team was made famous back in October for successfully
            completing the first ever BTC-ETH atomic swap - a complicated feat
            because these two coins run completely different blockchains.
            Altcoin.io Preview Interface Altcoin.io Preview Interface Bitshares
            already has a working platform, which works best as a client
            downloaded straight to the computer. Decentralized exchanges that
            are already working tend to be for the crypto-savvy; there are many
            ...
            exchanges. Centralized exchanges will focus on scaling, usability
            and adding of new tokens, while decentralized exchanges will be
            focusing on getting their product out on the web and involving the
            existing crypto community. But for now, and forever, it’s a good
            time to buy crypto.
          </div>
        </div>
      </div>
